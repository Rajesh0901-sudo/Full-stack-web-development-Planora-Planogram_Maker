...
<?php
    ...
    if($upc===0){
        ...
        $check_user_query = "SELECT * FROM pandf WHERE id = '$id' AND addedBy='$username'";
        ...
        if($row == 0){
            ...
            if(unlink($path)){
                $update = "DELETE FROM pandf WHERE id = '$id' AND addedBy='$username'";
